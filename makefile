...
SRCS = glad.cpp scene.cpp light.cpp skybox.cpp model.cpp mesh.cpp material.cpp texture.cpp camera.cpp shader.cpp axis.cpp gridlines.cpp glconfig.cpp utilities.cpp extmath.cpp window.cpp textureManager.cpp basicShapes.cpp main.cpp
OBJS = ${SRCS:.cpp=.o}
